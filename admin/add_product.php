  ...
  <div class="page-container">
    ...
    <main>
      ...
      <div class="template-buttons">
        ...
        <a href="admin_template.php?template=blue" class="template-blue">Blue</a>
        <a href="admin_template.php?template=red" class="template-red">Red</a>
        <a href="admin_template.php?template=orange" class="template-orange">Orange</a>
      </div>
